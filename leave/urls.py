...
from .views import CustomLoginView, HomePageView, RegisterView, LogouttView, ApplicationView, LeaveStatusView, TypeLeaveView

urlpatterns = [
    path('', RegisterView.as_view(), name='register'),
    path('login/', CustomLoginView.as_view(), name='login'),  # Use the custom LoginView
    path('logout/', LogouttView.as_view(), name='logout'),
